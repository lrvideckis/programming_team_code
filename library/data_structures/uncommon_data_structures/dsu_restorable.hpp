...
struct dsu_restorable {
    ...
    inline int size(int u) const {return -p[find(u)];}
    inline bool same_set(int u, int v) const {return find(u) == find(v);}
    inline long long sum(int u) const {return subtree[find(u)];}
