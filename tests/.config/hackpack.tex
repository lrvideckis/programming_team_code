...
% uncommon
\lstinputlisting[language=C++, caption={Disjoint Sparse Table}]{../library/data_structures/uncommon/disjoint_sparse_table.hpp}
\lstinputlisting[language=C++, caption={Number Distinct Elements}]{../library/data_structures/uncommon/distinct_query.hpp}
\lstinputlisting[language=C++, caption={Implicit Lazy Segment Tree}]{../library/data_structures/uncommon/implicit_seg_tree.hpp}
\lstinputlisting[language=C++, caption={Iterative Lazy Segment Tree}]{../library/data_structures/uncommon/iterative_lazy_segment_tree.hpp}
\lstinputlisting[language=C++, caption={Kth Smallest}]{../library/data_structures/uncommon/kth_smallest.hpp}
\lstinputlisting[language=C++, caption={Merge Sort Tree}]{../library/data_structures/uncommon/merge_sort_tree.hpp}
