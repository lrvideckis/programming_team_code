...
\lstinputlisting[language=C++, caption={Priority Queue of Updates}]{../library/data_structures/uncommon_data_structures/priority_queue_of_updates.hpp}
...
\lstinputlisting[language=C++, caption={Disjoint Sparse Table}]{../library/data_structures/uncommon_data_structures/disjoint_sparse_table.hpp}
\lstinputlisting[language=C++, caption={Number Distinct Elements}]{../library/data_structures/uncommon_data_structures/distinct_query.hpp}
\lstinputlisting[language=C++, caption={Implicit Lazy Segment Tree}]{../library/data_structures/uncommon_data_structures/implicit_seg_tree.hpp}
\lstinputlisting[language=C++, caption={Iterative Lazy Segment Tree}]{../library/data_structures/uncommon_data_structures/iterative_lazy_segment_tree.hpp}
\lstinputlisting[language=C++, caption={Kth Smallest}]{../library/data_structures/uncommon_data_structures/kth_smallest.hpp}
\lstinputlisting[language=C++, caption={Merge Sort Tree}]{../library/data_structures/uncommon_data_structures/merge_sort_tree.hpp}
