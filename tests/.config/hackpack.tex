...
\lstinputlisting[language=C++, caption={Heavy Light Decomposition}]{../library/graphs/heavy_light_decomposition.hpp}
\lstinputlisting[language=C++, caption={Hopcroft Karp}]{../library/graphs/hopcroft_karp.hpp}
\lstinputlisting[language=C++, caption={Lowest Common Ancestor}]{../library/graphs/lowest_common_ancestor.hpp}
...
\lstinputlisting[language=C++, caption={Binary Indexed Tree}]{../library/range_data_structures/binary_indexed_tree.hpp}
\lstinputlisting[language=C++, caption={Sparse Table}]{../library/range_data_structures/sparse_table.hpp}
\lstinputlisting[language=C++, caption={Disjoint Sparse Table}]{../library/range_data_structures/uncommon/disjoint_sparse_table.hpp}
\lstinputlisting[language=C++, caption={Recursive Lazy Segment Tree}]{../library/range_data_structures/lazy_segment_tree.hpp}
\lstinputlisting[language=C++, caption={Iterative Lazy Segment Tree}]{../library/range_data_structures/uncommon/iterative_lazy_segment_tree.hpp}
