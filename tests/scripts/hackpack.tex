...
\lstinputlisting[language=C++, caption={Disjoint RMQ}]{../library/range_data_structures/uncommon/disjoint_rmq.hpp}
...
\lstinputlisting[language=C++, caption={KMP String Matching}]{../library/strings/kmp.hpp}
