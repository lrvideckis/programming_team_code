...
\lstinputlisting[language=C++, caption={Suffix Array}]{../library/strings/suffix_array.hpp}
\lstinputlisting[language=C++, caption={LCP Array}]{../library/strings/longest_common_prefix.hpp}
\lstinputlisting[language=C++, caption={Longest Common Prefix Query}]{../library/strings/longest_common_prefix_query.hpp}
