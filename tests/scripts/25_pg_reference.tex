...
\lstinputlisting[language=bash, caption={Hash codes}]{scripts/hash.sh}
\lstinputlisting[language=bash, caption={Test on random inputs}]{scripts/test.sh}
...
\lstinputlisting[language=C++, caption={LCP}]{../library/strings/lcp.h}
