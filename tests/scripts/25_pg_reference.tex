...
\lstinputlisting[language=C++, caption={Segment Tree}]{../library/range_data_structures/seg_tree.h}
...
\lstinputlisting[language=C++, caption={Implicit Lazy Segment Tree}]{../library/range_data_structures/implicit_seg_tree.h}
\lstinputlisting[language=C++, caption={Range Updates, Point Queries}]{../library/range_data_structures/uncommon/fenwick_inv.h}
...
\lstinputlisting[language=C++, caption={Buckets}]{../library/range_data_structures/uncommon/buckets.h}
\lstinputlisting[language=C++, caption={Persistent Lazy Segment Tree}]{../library/range_data_structures/uncommon/persistent_lazy_seg_tree.h}
