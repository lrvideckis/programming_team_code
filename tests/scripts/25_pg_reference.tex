...
\lstinputlisting[language=C++, caption={Floyd Warshall}]{../library/graphs/floyd_warshall.h}
...
\lstinputlisting[language=C++, caption={Longest Common Prefix Query}]{../library/strings/pal_query.h}
...
\lstinputlisting[language=C++, caption={Prime Sieve Mobius}]{../library/math/prime_sieve_mobius.h}
...
\lstinputlisting[language=C++, caption={DSU}]{../library/misc/dsu.h}
