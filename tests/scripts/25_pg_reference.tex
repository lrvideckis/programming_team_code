...
\lstinputlisting[language=C++, caption={Lazy Segment Tree}]{../library/range_data_structures/lazy_seg_tree.h}
\lstinputlisting[language=C++, caption={Segment Tree, Point Updates}]{../library/range_data_structures/seg_tree.h}
\lstinputlisting[language=C++, caption={Range Hooks}]{../library/range_data_structures/range_hook.h}
...
\lstinputlisting[language=C++, caption={Log 2}]{../library/misc/log_2.h}
