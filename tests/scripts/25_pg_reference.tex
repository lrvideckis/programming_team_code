...
\lstinputlisting[language=C++, caption={Count Rectangles}]{../library/misc/monotonic_stack_related/cartesian_tree.h}
\lstinputlisting[language=C++, caption={Count Rectangles}]{../library/misc/monotonic_stack_related/max_rect_histogram.h}
