...
\lstinputlisting[language=C++, caption={Fenwick Tree}]{../library/range_data_structures/bit.h}
\lstinputlisting[language=C++, caption={Sparse Table}]{../library/range_data_structures/rmq.h}
...
\lstinputlisting[language=C++, caption={Longest Common Prefix Array}]{../library/strings/lcp.h}
...
\lstinputlisting[language=C++, caption={Disjoint Set}]{../library/misc/dsu.h}
...
\lstinputlisting[language=C++, caption={Longest Increasing Subsequence}]{../library/misc/lis.h}
