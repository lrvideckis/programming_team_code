...
\lstinputlisting[language=C++, firstline=0, lastline=3,   caption={Commonly Used Primes}]{math/commonprimes.cpp}
...
\lstinputlisting[language=C++, firstline=0, lastline=59,  caption={Mobius Prime Sieve}]{math/primeSieveMobius.cpp}
