...
\lstinputlisting[language=C++, firstline=0, lastline=35,  caption={Online Convex Hull}]{ds/onlineConvexHull.cpp}
\lstinputlisting[language=C++, firstline=0, lastline=49,  caption={Queue Max}]{ds/queueMax.cpp}
\lstinputlisting[language=C++, firstline=0, lastline=78,  caption={Two Sat}]{ds/twoSat.cpp}


\lstinputlisting[caption={\textbf{RANGE DATA STRUCTURES}}]{null} 
\lstinputlisting[language=C++, firstline=4, lastline=54,  caption={Mo's Algorithm}]{rangeDS/MosAlgo.cpp}
\lstinputlisting[language=C++, firstline=0, lastline=59,  caption={Fenwick Tree}]{rangeDS/fenwickTree.cpp}
\lstinputlisting[language=C++, firstline=0, lastline=24,  caption={Fenwick Tree 2D}]{rangeDS/fenwickTree2D.cpp}
\lstinputlisting[language=C++, firstline=1, lastline=80,  caption={Search Buckets}]{rangeDS/searchBuckets.cpp}
\lstinputlisting[language=C++, firstline=0, lastline=75,  caption={Seg Tree}]{rangeDS/segTree.cpp}
\lstinputlisting[language=C++, firstline=0, lastline=23,  caption={Sparse Table}]{rangeDS/sparseTable.cpp}
\lstinputlisting[language=C++, firstline=0, lastline=32,  caption={Sparse Table 2D}]{rangeDS/sparseTable2D.cpp}

\lstinputlisting[caption={\textbf{MATH}}]{null} 
\lstinputlisting[language=C++, firstline=3, lastline=43,  caption={Chinese Remainder Theorem}]{math/chineseRemainderTheorem.cpp}
\lstinputlisting[language=C++, firstline=0, lastline=86,  caption={Combinatorics, FastPow, ModInv}]{math/combinatorics.cpp}
\lstinputlisting[language=C++, firstline=0, lastline=3,   caption={Commonly Used Primes}]{math/commonprimes.txt}
\lstinputlisting[language=C++, firstline=0, lastline=75,  caption={Count Primes}]{math/countPrimes.cpp}
\lstinputlisting[language=C++, firstline=0, lastline=59,  caption={Discrete Log}]{math/discreteLog.cpp}
\lstinputlisting[language=C++, firstline=0, lastline=64,  caption={Fast Fourier Transform (FFT)}]{math/fft.cpp}
\lstinputlisting[language=C++, firstline=0, lastline=8,   caption={Fibonacci Sequence}]{math/fib.cpp}
\lstinputlisting[language=C++, firstline=0, lastline=76,  caption={Fractions}]{math/fraction.cpp}
\lstinputlisting[language=C++, firstline=0, lastline=25,  caption={Gaussian Elimination}]{math/gaussElimination.cpp}
\lstinputlisting[language=C++, firstline=0, lastline=27,  caption={Matrix Multiplication}]{math/matrixMultPow.cpp}
\lstinputlisting[language=C++, firstline=0, lastline=23,  caption={Partition Number}]{math/partition.cpp}
\lstinputlisting[language=C++, firstline=0, lastline=83,  caption={Pollard Rho}]{math/pollardRho.cpp}
\lstinputlisting[language=C++, firstline=0, lastline=59,  caption={Mobius Prime Sieve}]{math/primeSeiveMobius.cpp}
\lstinputlisting[language=C++, firstline=6, lastline=50,  caption={Rabin-Miller Primality Test}]{math/rabinMiller.cpp}
\lstinputlisting[language=C++, firstline=4, lastline=32,  caption={Sum Floor Arithmetic Series}]{math/sumFloorArithSeries.cpp}
\lstinputlisting[language=C++, firstline=0, lastline=66,  caption={Sum of Kth Powers}]{math/sumOfKthPowers.cpp}
\lstinputlisting[language=C++, firstline=0, lastline=19,  caption={Euler's Totient}]{math/totient.cpp}
